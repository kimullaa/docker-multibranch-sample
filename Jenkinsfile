...
node {
    ...
    docker.build("${BUILD_ID}", "-f Dockerfile.build .").inside("-u root -v /var/tmp/docker/cache/.m2:/${HOME_PATH}/.m2 -v /var/tmp/docker/cache/.node_modules:${CURRENT_PATH}/client/node_modules") {
